...
servo_cam, servo_base, servo_grip, servo_1, servo_2 = 30,10,0,120,0
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        global gripperLoc_x, gripperLoc_y, servo_cam
    ...
    def update_plot(self):
        ...
        x = np.array([distance_arm_cam, lx2])
        y = np.array([0, -ly2])
        z = np.array([0, 0])
    ...
    def update_frame(self):
        global object_distance, servo_cam
